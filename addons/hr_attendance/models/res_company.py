...
class ResCompany(models.Model):
    ...
    start_night_shift = fields.Float(string="Night shift start", default=0)
    end_night_shift = fields.Float(string="Night shift end", default=0)
    ...
    def _update_night_shift(self):
        return {
            'name': 'Night shift',
            'view_type': 'form',
            'view_mode': 'form',
            'view_id': self.env.ref('hr_attendance.update_night_shift_form_view').id,
