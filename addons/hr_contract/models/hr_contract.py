...
class Contract(models.Model):
    ...
    employee_code = fields.Char(related="employee_id.code", string='Mã nhân viên', readonly=True, store=False)
    ...
    calculation_start_date = fields.Date(string="Ngày bắt đầu tính phép")
    salary_form = fields.Char(string="Hình thức lương")
    ...
    wage = fields.Monetary(string="Tổng lương", tracking=True)
    salary_level = fields.Char(string="Bậc lương", tracking=True)
    basic_salary = fields.Monetary(string="Lương cơ bản", tracking=True)
    premium_salary = fields.Monetary(string="Lương đóng bảo hiểm", tracking=True)
    salary_scale = fields.Char(string="Thang tính lương", tracking=True)
    coefficients_salary = fields.Char(string="Hệ số lương", tracking=True)
    salary_supplement = fields.Char(string="Khoản bổ sung lương", tracking=True)
    bonus = fields.Monetary('Other rewards',tracking=True)
    kpi_bonus = fields.Monetary('KPI Bonus')
    ...
    contract_allowance_ids = fields.Many2many('hr.contract.allowance', 'contract_allowance_rel',
                                              'contract_id', 'contract_allowance_id', string='Phụ cấp')
    contract_files = fields.Binary(string='Tệp đính kèm')
    ...
    def print_contract(self):
        return self.env.ref('hr_contract.print_employee_contract').report_action(self)
