...
class HelpdeskTicketController(http.Controller):
    ...
    # def get_categories(self, mother_category_id):
    #     mother_categories = request.env["helpdesk.ticket.mother.category"].search([(1 , "=", 1)])
    #     if mother_category_id:
    #         mother_category = request.env["helpdesk.ticket.mother.category"].browse(int(mother_category_id))
    #         categories = mother_category.category_ids
    #     else:
    ...
    def create_new_ticket(self, **kw):
        ...
        mother_categories = http.request.env["helpdesk.ticket.mother.category"].search([(1 , "=", 1)])
        # mother_category = http.request.env["helpdesk.ticket.mother.category"].browse(
        #     int(kw.get("mother_category"))
        # )
        # to_int = int(mother_category.id)
        # mother_category = int(kw.get("mother_category", mother_categories[0].id))
        # # print(mother_category.id)
        # print(mother_category)
        
        # categories = self.get_categories(kw.get("mother_category"))
        ...
        return http.request.render(
            ...
            {   "mother_categories": mother_categories,
    ...
    def _prepare_submit_ticket_vals(self, **kw):
        ...
        vals = {
            ...
            "mother_category_id": mother_category.id,
