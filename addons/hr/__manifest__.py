...

{
    ...
    'data': [
        ...
        'views/claim_management_views.xml',
        'views/office_item_request_bill_views.xml',
        'views/office_request_views.xml',
        'views/print_doc_request_views.xml',
        'views/print_doc_category_views.xml',
        'views/print_doc_type_views.xml',
        'views/print_doc_unit_views.xml',
        'data/hr_data.xml',
    ],
    'demo': [
        'data/hr_demo.xml'
