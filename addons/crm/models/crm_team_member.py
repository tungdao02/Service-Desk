...
class TeamMember(models.Model):
    ...
    def _assign_and_convert_leads(self, team_id, work_days=1):
        ...
        """ Ignore this validation, it should be assign manually.
        ...
        leads_count = self.env["crm.lead"].search_count(expression.AND([
                ['&', '&', ('user_id', '=', False), ('date_open', '=', False), ('team_id', '=', team_id)]
            ]))
