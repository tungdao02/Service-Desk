...

{
    ...
    'data': [
        ...
        'wizard/crm_phone_ext_number_views.xml',
        ...
        'views/crm_lead_storage_views.xml',
        ...
        'views/crm_phone_call_trans_views.xml',
        'views/crm_lead_assign_views.xml',
        'views/crm_phonecalls_views.xml',
